...
abstract class Conexion{
	...
	abstract protected function obtenerRegistro($id);
	abstract protected function guardar($registro);
	abstract protected function borrar($id);
	abstract protected function modificar($id,$registro);
